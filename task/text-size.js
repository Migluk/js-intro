...
- jei maziau 10 simboriu: "Trumpas tekstas in N simboliu."
- jei maziau 20 simboliu: "Tekstas is N simboliu."
- jei ilgesnis: "Ilgas tekstas in N simboliu."
*/
...
function textSize(text) {
    ...
    if (text.length < 10) {
        return `Trumpas tekstas in ${text.length} simboliu.`;
    } 
    ...
    return `Ilgas tekstas in ${text.length} simboliu.`;
}
